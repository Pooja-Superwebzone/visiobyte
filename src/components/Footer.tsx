...
import BehanceIcon from "@/components/assets/behance.png";
import Blur1 from "@/components/assets/blur.png";
import DribbbleIcon from "@/components/assets/dribbble.png";
import FacebookIcon from "@/components/assets/facebook.png";
import InstagramIcon from "@/components/assets/instagram.png";
...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-neutral-950 text-neutral-200 flex flex-col justify-between  min-h-[clamp(480px,60vh,640px)]">
      <Image src={Blur1}  alt="Gradient Glow" className="pointer-events-none absolute top-0 right-0 blur-xlz-0 object-cover"/>
